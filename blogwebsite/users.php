  ...
  <div id="wrapper">
    ...
    <section id="content-wrapper">
      <div class="container my-8">
        ...
        <button1 type="button" class="btn btn-dark my-4" data-bs-toggle="modal" data-bs-target="#completeModal"><a href="index.php"> Add New Users</a>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label for="completecat">Username</label>
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text bg-dark">
                          <i class="fas fa-phone text-light my-2"></i></span>
                      </div>
                      <input type="text" class="form-control" id="completecat" name="email">
                    </div>
                  </div>
