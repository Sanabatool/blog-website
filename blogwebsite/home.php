...
<body>
    ...
    <section class="home" id="home">
        <div class="home-text container">
            <h2 class="home-title">The Blogs</h2>
            <span class="home-subtitle">Your sources of great content</span>
            <p class="first_line">Blog On When Life Gets Tough</p>
            <button type="button" class="start" onclick="location.href='login.php'">
                Start here
            </button>
            <div class="stars"></div>
        </div>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            <div class="image">
                <img src="picography-blonde-meeting-desk-768x512.jpg" alt="" style="border-radius: 10%">
            </div>
            <div class="content">
                <h3>What makes us Special</h3>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vel, soluta impedit repudiandae mollitia excepturi, labore quaerat sit accusamus non omnis sunt repellat ipsa consectetur tempore! Dolorem, dolorum autem? Fugiat, saepe!</p>
                <p>Lorem, ipsum doi accusantium vero sint molestiae nulla tempore.</p>
            ...
            <div class="rowed">
                                ...
                                <div class="col-sm-4">
                                    <ul class="list-unstyled">
                                        <?php while ($cats = mysqli_fetch_assoc($query)) { ?>
                                            <li>
                                                <a href="homeCategory.php?id=<?php echo $cats['cat_id'] ?>">
                ...
                <div class="row1">
                    ...
                    $sql = "SELECT * FROM posts 
                        ...
                        ORDER BY posts.date DESC limit $limit";
                    ...
                    ?>
                            <div class="post-container">
                                <div class="post-box" style="width: 80%;">
                                    <div class="post-img">
                                        <a href="#!" class="pt-img">
                                            <?php $img = $result['file'] ?>
                                    ...
                                    <div class="post-text">
                                        <h1 class="card-title"><?php echo ucfirst($result['title']) ?></h1>
                    ...
                    <br>
                    <button type="button" class="login1" onclick="location.href='blogs.php'" style="margin-left: 70%; width: 15%;">Show More</button>
